        ...
        <div class="col-12">
            ...
            <form action="{{ route('user.update') }}" method="post">
                ...
                <div class="form-group row">
                    <label for="gender" class="col-md-3 col-form-label text-md-right">Civilité</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="birthdate" class="col-md-3 col-form-label text-md-right">Date de naissance</label>
                    <div class="col-md-6">
                        <input type="date"
                               name="birthdate"
                ...
                <div class="form-group row">
                    <label for="address_line1" class="col-md-3 col-form-label text-md-right">Adresse</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="address_line2" class="col-md-3 col-form-label text-md-right">Adresse 2</label>
                    <div class="col-md-6">
                        <input type="text"
                               name="address_line2"
                ...
                <div class="form-group row">
                    <label for="city" class="col-md-3 col-form-label text-md-right">Ville</label>
                    <div class="col-md-6">
                        <input type="text"
                               name="city"
                ...
                <div class="form-group row">
                    <label for="zipcode" class="col-md-3 col-form-label text-md-right">Code Postal</label>
                    <div class="col-md-6">
                        <input type="text"
                               name="zipcode"
                ...
                <div class="form-group row">
                    <label for="phone_1" class="col-md-3 col-form-label text-md-right">Téléphone 1</label>
                    <div class="col-md-6">
                        <input type="text"
                               name="phone_1"
                ...
                <div class="form-group row">
                    <label for="phone_2" class="col-md-3 col-form-label text-md-right">Téléphone 2</label>
                    <div class="col-md-6">
                        <input type="text"
                               name="phone_2"
                ...
                <h4 class="mt-5 mb-4">Information du conjoint</h4>

                <div class="form-group row">
                    <label for="gender_joint" class="col-md-3 col-form-label text-md-right">Civilité conjoint</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="lastname_joint" class="col-md-3 col-form-label text-md-right">Nom</label>
                    <div class="col-md-6">
                        <input type="text"
                               name="lastname_joint"
                ...
                <div class="form-group row">
                    <label for="firstname_joint" class="col-md-3 col-form-label text-md-right">Prénom</label>
                    <div class="col-md-6">
                        <input type="text"
                ...
                <div class="form-group row">
                    <label for="birthdate_joint" class="col-md-3 col-form-label text-md-right">Date de naissance</label>
                    <div class="col-md-6">
                        <input type="date"
                ...
                <div class="form-group row">
                    <label for="email_joint" class="col-md-3 col-form-label text-md-right">Email conjoint</label>
                    <div class="col-md-6">
                        <input type="email"
                               name="email_joint"
