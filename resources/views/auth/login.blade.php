...
<body class="bg-stone-200 flex content-center  justify-center h-full items-center">
    <div class="max-w-lg bg-white shadow-lg rounded-md">
        ...
        <div class="p-4 flex-1">
            ...
            <div class="w-full flex justify-center">
                <a href="http://0.0.0.0/index/userpage"><button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Se connecter</button></a>        
            </div>
        </div>
    </div>
</body>